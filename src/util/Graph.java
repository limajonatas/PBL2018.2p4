...
public class Graph<V, E> implements IGraph<V, E> {
    ...
    public void addEdge(V v, V u, E data) {
        Vertice ver1 = getVertice(v);
        Vertice ver2 = getVertice(u);
        //Verifica se os vertices pertencem ao grafo
        if (verList.contains(ver1) && verList.contains(ver2)) {
    ...
    public void removeVertex(V v) {
        ...
        Vertice ver1 = this.getVertice(v);
        this.edgeList.removeAll(ver1.incidenceList.values());
        this.verList.remove(this.getVertice(v));
    }
    ...
    public E getEgde(V v, V u) {
        ...
        if (ver != null && ver1 != null) {
            for (Edge e : edgeList) {
                if (e.incVertex.contains(ver) && e.incVertex.contains(ver1)) {
                    return (E) e.weight;
                }
            }
        }
    ...
    private class Vertice<V> {
        ...
        public void addEdge(Vertice vertice, Edge edge) {
